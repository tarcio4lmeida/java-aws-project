...
public class InvoiceAppStack extends Stack {
    ...
    public InvoiceAppStack(final Construct scope, final String id, final StackProps props) {
        ...
        SnsTopic s3InvoiceTopic = SnsTopic.Builder
                .create(Topic.Builder.create(this, "S3InvoiceTopic")
                        .topicName("s3-invoice-events")
                        .build())
                        .build();

        this.bucket = Bucket.Builder.create(this, "S301")
                .bucketName("pcs00000000001-invoice")
                .removalPolicy(RemovalPolicy.DESTROY)
                .build();

        this.bucket.addEventNotification(EventType.OBJECT_CREATED_PUT, new SnsDestination(s3InvoiceTopic.getTopic()));
        ...
        this.s3InvoiceQueue = Queue.Builder.create(this, "S3InvoiceQueue")
